<template>
  <div>
    ...
    <div class="breadcrumb">
      <div class="container">
        <h2>
          <router-link to="">首页</router-link>&gt;<router-link to="">产品中心</router-link>
        </h2>
      </div>
    </div>
    <!--页面主体-->
        ...
        <div class="cart_con">
          ...
          <ul>
            ...
            <li>
              ...
              <router-link to="" class="cart_img"><img src="../assets/product-imgs/jhq-m8088a.jpg" alt=""/></router-link>
              <router-link to="" class="cart_title">家用除甲醛静音M-8088A</router-link>
              <i>¥1599</i>
              <div>
